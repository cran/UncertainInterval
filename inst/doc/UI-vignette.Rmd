...
**NOTE 4:** The size of the uncertain interval is open for discussion. In the case of PSA it is certainly possible to argue for a wider interval of uncertian test scores.
